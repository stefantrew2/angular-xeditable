 ...
 *
 */
angular.module('xeditable', ['ngSanitize','ui.bootstrap', 'ngIntlTelInput'])
...
angular.module('xeditable').directive('editableTagsInput', ['editableDirectiveFactory', 'editableUtils',
  function(editableDirectiveFactory, editableUtils) {
    ...
    angular.module('xeditable').directive("editablePhoneNumber", ['editableDirectiveFactory',
      function(editableDirectiveFactory) {
        return editableDirectiveFactory({
          directiveName: "editablePhoneNumber",
          inputTpl: '<input type="tel" ng-model="a" ng-intl-tel-input>',
          render: function() {
            this.parent.render.call(this);
  ...
  function(editableDirectiveFactory) {
    ...
    var dir =  editableDirectiveFactory({
      ...
      render: function() {
        ...
        var nowEl = angular.element('<div class="btn btn-success"><span class="fa fa-gear"></span></div>');
        this.inputEl.append(nowEl);

        nowEl.bind('click', function() {
          setTimeout(function() {
            self.scope.$apply(function() {
              self.scope.$data = new Date();
            });
          }, 0);
        });
      },
